...
RSpec.describe Manifold::API::Workspace do
  ...
  describe "#generate" do
    context "when the manifold configuration exists" do
      ...
      it_behaves_like "breakout metrics", "paid"
      it_behaves_like "breakout metrics", "organic"
      it_behaves_like "breakout metrics", "us"
      it_behaves_like "breakout metrics", "global"
      it_behaves_like "breakout metrics", "retargeting"
      it_behaves_like "breakout metrics", "prospecting"

      # Test two-way intersection fields
      it_behaves_like "breakout metrics", "paidUs"
      it_behaves_like "breakout metrics", "paidGlobal"
      it_behaves_like "breakout metrics", "organicUs"
      it_behaves_like "breakout metrics", "organicGlobal"
      it_behaves_like "breakout metrics", "paidRetargeting"
      it_behaves_like "breakout metrics", "paidProspecting"
      it_behaves_like "breakout metrics", "organicRetargeting"
      it_behaves_like "breakout metrics", "organicProspecting"
      it_behaves_like "breakout metrics", "usRetargeting"
      it_behaves_like "breakout metrics", "usProspecting"
      it_behaves_like "breakout metrics", "globalRetargeting"
      it_behaves_like "breakout metrics", "globalProspecting"

      # Test three-way intersection fields
      it_behaves_like "breakout metrics", "paidUsRetargeting"
      it_behaves_like "breakout metrics", "paidUsProspecting"
      it_behaves_like "breakout metrics", "paidGlobalRetargeting"
      it_behaves_like "breakout metrics", "paidGlobalProspecting"
      it_behaves_like "breakout metrics", "organicUsRetargeting"
      it_behaves_like "breakout metrics", "organicUsProspecting"
      it_behaves_like "breakout metrics", "organicGlobalRetargeting"
      it_behaves_like "breakout metrics", "organicGlobalProspecting"
